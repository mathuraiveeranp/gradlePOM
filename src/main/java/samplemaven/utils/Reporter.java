...
public class Reporter {
	...
	public String testcaseName, testcaseDesc, author, category, testNode;
	...
	public void startTestcase() {
		...
		node = test.createNode(testNode);
	}
	
	public void reportStep(String testStatus, String desc, boolean bSnap) throws IOException {
